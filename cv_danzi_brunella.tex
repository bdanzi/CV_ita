...
Studentessa di Dottorato in Fisica Sperimentale delle Particelle Elementari, Novembre 2021\\
Progetto di Ricerca:
    \href{https://inspirehep.net/literature/1955669}{Ricerca di eventi di coppia di bosoni di Higgs nel canale di decadimento in $b\overline{b}mumu$ con l'esperimento CMS a LHC e futuri collisionatori}\\
...
Supporto didattico integrativo per gli studenti dei Corsi di Laurea Triennali in Biotecnologie Mediche e Farmaceutiche (BMF), Biotecnologie Industriali e Agro-Alimentari (BIA), Biotecnologie Industriali per lo Sviluppo Sostenibile (BISS) del Dipartimento di Bioscienze, Biotecnologie e Biofarmaceutica.
...
\href{https://dottorato.fisica.uniba.it}{Borsa di studio di tre anni per Dottorato in Fisica all'Università di Bari e Associazione INFN} \textbf{(\textit{2021--Presente})}\\
...
\href{https://www.ecomap.it/prestazione.asp?idPR=14}{Premio di studio per Studenti Italiani Triennali e Magistrali ECOMAP} \textbf{(\textit{2016--2020})}\\
...
\textbf{Efficienza HEP/Tag and Probe Muon Tracking.} Misurazione dell'efficienza di tracciamento Muon nell'esperimento CMS utilizzando il metodo Tag and Probe \textbf{(\textit{Marzo 2022--Presente})}
...
%\textbf{2021 Workshop ACAT, Sessione poster.} (\textit{1 dicembre 2021})\\ %\href{https://indico.cern.ch/event/855454/contributions/4596351/}{Segnale in background discriminazione per la produzione di doppi eventi di bosone %Higgs tramite il meccanismo di fusione del bosone vettoriale nel canale di decadimento con quattro leptoni carichi e due b-jet nello stato % finale dell'esperimento LHC.}\\

%\textbf{ML\_INFN gruppo di ricerca, Review use-case.} (\textit{15 novembre 2021})\\
%\href{https://agenda.infn.it/event/29006/}{Discriminazione segnale/sfondo per il canale di decadimento dei quattro leptoni VBF Higgs con l'esperimento %CMS.}\\

%\textbf{ML\_INFN gruppo di ricerca, presentazione di casi d'uso.} (\textit{26 aprile 2021})\\
%\href{https://agenda.infn.it/event/26762/}{Discriminazione segnale/sfondo per il canale di decadimento dei quattro leptoni VBF Higgs con l'esperimento %CMS utilizzando tecniche di classificazione Machine Learning.}\\

\textbf{Università degli Studi di Bari, Seminario per studenti di Laurea Magistrale in Fisica} \textbf{(\textit{15 marzo 2021})}\\
\href{https://recascloud.ba.infn.it/index.php/s/ItcCFRRq3gKGuXx}{\textit{"Seminario "The Top Quark discovery at the Fermilab Tevatron collider"}} %durante il \textit{Elementary Particle Physics } corso per studenti del primo anno magistrale in Fisica delle particelle, astroparticelle e tecnologie avanzate\\
