...
Laurea Magistrale, Nuclear, Subnuclear and Astroparticle Physics, Ottobre 2021\\
Dissertazione:
...
\textbf{Tutor Didattico in \textit{Fisica Applicata con laboratorio}, Università di Bari. (\textit{Marzo 2021-- Dicembre 2021})}\\
Supporto didattico integrativo di 250 ore per gli studenti dei Corsi di Laurea Triennali in Biotecnologie Mediche e Farmaceutiche (BMF) e Biotecnologie Industriali e Agro-Alimentari (BIA) del Dipartimento di Bioscienze, Biotecnologie e Biofarmaceutica.\\
...
\textbf{Incontro tra l'INFN, IHEP e l'Universtità di Jilin -- Presentatrice } (\textit{18 Febbraio 2022}) \\
