...
\textbf{Machine learning/Higgs tagging.} Sviluppo di una Deep Neural Network per l'identificazione di bosoni Higgs che decadono in quattro leptoni carichi (4mu,4e,2e2mu) nell'esperimento CMS (\textit{2021--Presente}).\\
