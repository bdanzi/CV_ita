...
\textbf{Tutor Didattico in \textit{Fisica Applicata con laboratorio} presso il Dipartimento di Bioscienze, Biotecnologie e Biofarmaceutica, Università di Bari. (\textit{Marzo 2021--2022})}\\
Supporto didattico integrativo per gli studenti dei Corsi di Laurea Triennali in Biotecnologie Mediche e Farmaceutiche (BMF) e Biotecnologie Industriali e Agro-Alimentari (BIA).\\
