...
\textbf{Tutor Didattico in \textit{Fisica Applicata con laboratorio} presso l'Università di Bari. (\textit{Marzo 2021--2022})}\\
Supporto didattico integrativo per gli studenti dei Corsi di Laurea Triennali in Biotecnologie Mediche e Farmaceutiche (BMF) e Biotecnologie Industriali e Agro-Alimentari (BIA) del Dipartimento di Dipartimento di Bioscienze, Biotecnologie e Biofarmaceutica.\\
...
\href{https://www.ecomap.it/prestazione.asp?idPR=14}{Premio di studio ECOMAP} \textbf{(\textit{2016--2020})}\\
...
\textbf{Confronto tra l'INFN di Bari e Lecce, IHEP e l'Universtità di Jilin -- Presentatrice } \textbf{(\textit{18 Febbraio 2022})} \\
